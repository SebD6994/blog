...
class Admin_serviceController {
    ...
    // Constructor to initialize the database connection and service model
    public function __construct($db) {
        $this->db = $db;
        $this->serviceModel = new Service($this->db); // Initialize the serviceModel with the database connection
    }
